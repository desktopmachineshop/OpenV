...
// Context-aware help panel, mounted once in ProjectLayout so the floating ?
// button is available on every project page. It reads the current route and
...
// Keyed by the first path segment after /projects/:projectId.
