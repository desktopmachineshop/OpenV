...
| --- | --- |
| Workspace members | People in the workspace. **Invitations you have sent but nobody has accepted count towards it**, so a seat is reserved from the moment you invite somebody. |
